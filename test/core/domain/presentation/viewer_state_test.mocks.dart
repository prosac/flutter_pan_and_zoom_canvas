...
class MockDraggingProcedure extends _i1.Mock implements _i5.DraggingProcedure {
  ...
  @override
  Function get notifier => (super.noSuchMethod(
        Invocation.getter(#notifier),
        returnValue: () {},
      ) as Function);
  @override
  set notifier(Function? _notifier) => super.noSuchMethod(
        Invocation.setter(
          #notifier,
          _notifier,
        ),
  ...
  @override
  set scale(double? _scale) => super.noSuchMethod(
        Invocation.setter(
          #scale,
          _scale,
        ),
  ...
  void start(
    dynamic node,
    dynamic scale,
    dynamic interactiveViewerOffset,
    dynamic onTick,
  ) =>
      super.noSuchMethod(
        Invocation.method(
